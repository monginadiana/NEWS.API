...
class ArticlesTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        '''
        self.new_article = Articles('Peter Polle','The tech scene in Africa-Is it the next big thing?','A look at various tech hubs in Africa and the impact they have on the worlds economy','techie.com','techie.com/7643t94.jpg','2018-04-11T07:57:16Z')
    ...
    def test_to_check_instance_variables(self):
        ...
        self.assertEqual(self.new_article.publishedAt,'2018-04-11T07:57:16Z')
